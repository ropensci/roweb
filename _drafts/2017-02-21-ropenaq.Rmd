...
This is how I make the visualization itself, using once again `magick`, and also [`albersusa`](https://github.com/hrbrmstr/albersusa). The package has to be installed from Github: `devtools::install_github("hrbrmstr/albersusa")`. Note that I don't show Alaska and Hawai.
