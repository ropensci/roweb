...
This is how I make the visualization itself, using once again `gganimate`, and also `albersusa`. Note that I don't show Alaska and Hawai.
...
gg_animate(plotMap, "fireworks.gif")
