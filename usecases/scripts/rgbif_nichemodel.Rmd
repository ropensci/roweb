...
(1) Add raster data, (2) Add political boundaries, (3) Add the points (occurrences)</h3>
...
The above example comes from [this tutorial](http://cran.r-project.org/web/packages/dismo/vignettes/sdm.pdf) on species distribution modeling.