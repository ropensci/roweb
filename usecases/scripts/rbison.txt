...
We'll not restrain our search to any particular taxonomic group, although you will likely do that in your own research. 
...
Plot species-abundance distributions using the `radfit` function in vegan
