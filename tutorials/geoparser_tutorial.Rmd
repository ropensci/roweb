...
knitr::opts_chunk$set(
	fig.path = "../assets/tutorial-images/geoparser/",
  comment = "#>",
  collapse = TRUE,
  warning = FALSE,
  message = FALSE
...
devtools::install_github("ropenscilabs/geoparser")
```
...
> Maëlle Salmon (NA). geoparser: Interface to the Geoparser.io API for
  Identifying and Disambiguating Places Mentioned in Text. R package version
  0.1.0. https://cran.rstudio.com/package=geoparser
...
* Report bugs at [our GitHub repo for geoparser](https://github.com/ropenscilabs/geoparser/issues?state=open)
