...
knitr::opts_chunk$set(
	fig.path = "../assets/tutorial-images/convertr/",
  comment = "#>",
  warning = FALSE,
  message = FALSE
)
...
![Gadget Animation](../assets/tutorial-images/convertr/convertr_gif.gif)

<section id="citing">

## Citing

> Gordon Shotwell (2015). convertr: Convert Between Units. R package version 0.1. https://github.com/ropenscilabs/convertr
