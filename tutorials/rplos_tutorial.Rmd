...
opts_chunk$set(fig.path="../assets/tutorial-images/rplos/")
```
...
```{r searchplos1, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
searchplos(terms = "Helianthus", fields = "id", limit = 5)
```

Get only full article DOIs

```{r searchplos2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
searchplos(terms="*:*", fields='id', toquery='doc_type:full', start=0, limit=20)
```

Get DOIs for only PLoS One articles

```{r searchplos3, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
searchplos(terms="*:*", fields='id', toquery='cross_published_journal_key:PLoSONE', start=0, limit=15)
```

Get DOIs for full article in PLoS One

```{r searchplos4, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r searchplos5, message=FALSE, warning=FALSE, comment=NA}
...
```{r plosauthor, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r plosabstract, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r plostitle, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r plosword, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r plosword2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r throughtime1, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
plot_throughtime(terms = "phylogeny", limit = 200, gvis = FALSE)
```

```{r throughtime2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
