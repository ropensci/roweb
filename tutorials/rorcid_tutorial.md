...
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.9176994    NA       NA               NA                NA
#> 2              0.6513734    NA       NA               NA                NA
#> 3              0.5210987    NA       NA               NA                NA
#> 4              0.3685606    NA       NA               NA                NA
#> 5              0.3245716    NA       NA               NA                NA
#> 6              0.3245716    NA       NA               NA                NA
#> 7              0.3245716    NA       NA               NA                NA
#> 8              0.3245716    NA       NA               NA                NA
#> 9              0.3127341    NA       NA               NA                NA
#> 10             0.3072306    NA       NA               NA                NA
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.4370576    NA       NA               NA                NA
#> 2              0.4150351    NA       NA               NA                NA
#> 3              0.3666495    NA       NA               NA                NA
#> 4              0.3648929    NA       NA               NA                NA
#> 5              0.3621934    NA       NA               NA                NA
#> 6              0.3289034    NA       NA               NA                NA
#> 7              0.3104515    NA       NA               NA                NA
#> 8              0.3104515    NA       NA               NA                NA
#> 9              0.3104515    NA       NA               NA                NA
#> 10             0.3070747    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.5990999    NA       NA               NA                NA
#> 2              0.4152694    NA       NA               NA                NA
#> 3              0.4090294    NA       NA               NA                NA
#> 4              0.4076623    NA       NA               NA                NA
#> 5              0.3684072    NA       NA               NA                NA
#> 6              0.3676553    NA       NA               NA                NA
#> 7              0.3676553    NA       NA               NA                NA
#> 8              0.3451786    NA       NA               NA                NA
#> 9              0.3436562    NA       NA               NA                NA
#> 10             0.3351477    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr), delegation
...
#>   relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                   (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1             0.3666495    NA       NA               NA                NA
#> 2             0.3648929    NA       NA               NA                NA
#> 3             0.3621934    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.8907297    NA       NA               NA                NA
#> 2              0.7935251    NA       NA               NA                NA
#> 3              0.7587552    NA       NA               NA                NA
#> 4              0.7587552    NA       NA               NA                NA
#> 5              0.7587552    NA       NA               NA                NA
#> 6              0.7346615    NA       NA               NA                NA
#> 7              0.7346615    NA       NA               NA                NA
#> 8              0.7346615    NA       NA               NA                NA
#> 9              0.7346615    NA       NA               NA                NA
#> 10             0.7346615    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr),
...
#>   relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                   (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1             14.393855    NA       NA               NA                NA
#> 2              7.196928    NA       NA               NA                NA
#> 3              7.124595    NA       NA               NA                NA
#> 4              6.232722    NA       NA               NA                NA
#> 5              6.106795    NA       NA               NA                NA
#> 6              4.986177    NA       NA               NA                NA
#> 7              2.035598    NA       NA               NA                NA
#> 8              1.079539    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr), delegation
...
#>   relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                   (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1             0.8978919    NA       NA               NA                NA
#> 2             0.7856554    NA       NA               NA                NA
#> 3             0.7480615    NA       NA               NA                NA
#> 4             0.7242363    NA       NA               NA                NA
#> 5             0.7119786    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr),
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.2436589    NA       NA               NA                NA
#> 2              0.1880214    NA       NA               NA                NA
#> 3              0.1661890    NA       NA               NA                NA
#> 4              0.1628313    NA       NA               NA                NA
#> 5              0.1628313    NA       NA               NA                NA
#> 6              0.1628313    NA       NA               NA                NA
#> 7              0.1628313    NA       NA               NA                NA
#> 8              0.1628313    NA       NA               NA                NA
#> 9              0.1506216    NA       NA               NA                NA
#> 10             0.1410160    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr), biography
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.3111271    NA       NA               NA                NA
#> 2              0.1955038    NA       NA               NA                NA
#> 3              0.1728026    NA       NA               NA                NA
#> 4              0.1693113    NA       NA               NA                NA
#> 5              0.1693113    NA       NA               NA                NA
#> 6              0.1693113    NA       NA               NA                NA
#> 7              0.1693113    NA       NA               NA                NA
#> 8              0.1693113    NA       NA               NA                NA
#> 9              0.1566157    NA       NA               NA                NA
#> 10             0.1466278    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr), biography
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.1810425    NA       NA               NA                NA
#> 2              0.1600205    NA       NA               NA                NA
#> 3              0.1567874    NA       NA               NA                NA
#> 4              0.1567874    NA       NA               NA                NA
#> 5              0.1567874    NA       NA               NA                NA
#> 6              0.1567874    NA       NA               NA                NA
#> 7              0.1567874    NA       NA               NA                NA
#> 8              0.1450309    NA       NA               NA                NA
#> 9              0.1357819    NA       NA               NA                NA
#> 10             0.1357819    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr), biography
...
#>    relevancy-score.value orcid orcid-id orcid-deprecated orcid-preferences
#>                    (dbl) (lgl)    (lgl)            (lgl)             (lgl)
#> 1              0.1923342    NA       NA               NA                NA
#> 2              0.1700010    NA       NA               NA                NA
#> 3              0.1665663    NA       NA               NA                NA
#> 4              0.1665663    NA       NA               NA                NA
#> 5              0.1665663    NA       NA               NA                NA
#> 6              0.1665663    NA       NA               NA                NA
#> 7              0.1665663    NA       NA               NA                NA
#> 8              0.1540766    NA       NA               NA                NA
#> 9              0.1503418    NA       NA               NA                NA
#> 10             0.1442506    NA       NA               NA                NA
#> Variables not shown: orcid-history (lgl), orcid-activities (lgl),
#>   orcid-internal (lgl), type (lgl), group-type (lgl), client-type (lgl),
#>   orcid-identifier.value (lgl), orcid-identifier.uri (chr),
#>   orcid-identifier.path (chr), orcid-identifier.host (chr), biography
...
> Scott Chamberlain (2016). rorcid: Interface to the 'Orcid.org' 'API'. R package version 0.2.2. 
