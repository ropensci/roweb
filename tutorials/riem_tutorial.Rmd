...
knitr::opts_chunk$set(
	fig.path = "../assets/tutorial-images/riem/",
  comment = "#>",
  collapse = TRUE,
  warning = FALSE,
  message = FALSE
...
> Maëlle Salmon. 2016. riem: Accesses Weather Data from the Iowa Environment
  Mesonet. R package version 0.1.0. https://cran.rstudio.com/package=riem
