...
# Future developments
The hddtools package contains functions to interact with a limited number of sources but there is a long list of useful datasets that could be potentially added. One example is the real-time precipitation data from the UK MetOffice.
If you have suggestions, please add them to the [issue tracker](https://github.com/ropensci/hddtools/issues) on github. Also, feel free to contribute to the package sending a [pull request](https://github.com/ropensci/hddtools/pulls), that would be greatly appreciated!
